...
// Load this file's selection again by visiting: http://mootools.net/more/e8605897da73f6270c39fbcfc2151a4f 
// Or build this file again with packager using: packager build More/String.QueryString More/Slider
/*
---
copyrights:
...
return a?a.call(null,c,d):(d||d===0);}).join("&");}});Class.Mutators.Binds=function(a){if(!this.prototype.initialize){this.implement("initialize",function(){});
